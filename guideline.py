...
# PRINCIPLE 1
  ...
  # TACTIC 1 : Use delimiters (delimiter: ayırıcı,sınırlayıcı)
    # --> Triple qutes: """ """
    # --> Triple backticks: ``` ```
    # --> Triple dashes: --- ---
    # --> Angle brackets: < >
...
print(response)
  ...
  # --> In this example, model gives the wrong answer. We can fix this by instructing the model to work out its own solution first.
prompt = f"""
